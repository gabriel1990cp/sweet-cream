...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_menu_page( __('Theme Options', 'options_framework_theme'), __('Theme Options', 'options_framework_theme'), 'edit_theme_options', 'options-framework','optionsframework_page',OPTIONS_FRAMEWORK_DIRECTORY.'/images/themeimg1.png' );
...
function optionsframework_page() {
	settings_errors(); ?>
	<div class="settings-error-save"></div>
	<div id="optionsframework-wrap" class="wrap">
    <div class="optionmain">
		<div class="optionthemepanel">
			<div class="themename">WindCake</div>
		</div>
...
function my_admin_scripts() {
  ...
  wp_register_script('my-upload', OPTIONS_FRAMEWORK_DIRECTORY.'/js/admin.js', array('jquery','media-upload','thickbox'));
  wp_enqueue_script('my-upload');
  wp_register_script('font-select', OPTIONS_FRAMEWORK_DIRECTORY.'/js/jquery.fontselect.min.js', array('jquery'));
  wp_enqueue_script('font-select');  
}

function my_admin_styles() {
  wp_enqueue_style('thickbox');
  wp_enqueue_style( 'fonticons', OPTIONS_FRAMEWORK_DIRECTORY.'/css/font-awesome.min.css' );	  
  wp_enqueue_style( 'adminoptions', OPTIONS_FRAMEWORK_DIRECTORY.'/css/admin.css' );	
  wp_enqueue_style( 'fontselect', OPTIONS_FRAMEWORK_DIRECTORY.'/css/fontselect.css' );	
